...
handler.before = async function (m, { conn, participants, groupMetadata }) {
  ...
  let edit = `❀ ${usuario} Ha permitido que ${m.messageStubParameters[0] == 'on' ? 'solo admins' : 'todos'} puedan configurar el grupo.`
  ...
  let noadmingp = `❀ *Admin Removido*\n➪ @${m.messageStubParameters[0].split('@')[0]} dejó de ser admin\n> Acción de › ${usuario}`
